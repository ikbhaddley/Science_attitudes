...
data1$BeforePand_1 <- as.numeric(as.character(revalue(data1$BeforePand_1, c("Strongly agree"=1, "Agree"=1, "Disagree"=0,"Strongly disagree"=0, "Neither agree or disagree"=0 ))))
data1$BeforePand_2 <- as.numeric(as.character(revalue(data1$BeforePand_2, c("Strongly agree"=1, "Agree"=1, "Disagree"=0,"Strongly disagree"=0, "Neither agree or disagree"=0 ))))
data1$BeforePand_3 <- as.numeric(as.character(revalue(data1$BeforePand_3, c("Strongly agree"=0, "Agree"=0, "Disagree"=1,"Strongly disagree"=1, "Neither agree or disagree"=0 ))))
...
write.csv(data1, "survey_data_recoded_mine_fullneg.csv", row.names = FALSE)

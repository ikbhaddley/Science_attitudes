...
pacman::p_load(vioplot, metap, ggplot2, MASS, Hmisc, plyr, ltm, epiDisplay,VennDiagram)
...
data1 <- read.csv(file = "survey_data_recoded_mine_veryneg.csv", header=TRUE)
...
p.vac.u.bon <- ifelse(p.vac.u< .0125, "!", "")
...
## remove sex, age, pol
logistic.hy.demographic.2 <- glm(hy ~ know+su+rel2+rel3,data=df.hy.demographic.1, family="binomial")
...
anova (logistic.gm.demographic.2,logistic.gm.demographic, test="LRT")
...
logistic.vac.demographic.2 <- glm(vac ~ know+pol+age+edu2+edu3+sex,data=df.vac.demographic.1, family="binomial")
...
odd.pol.demo.vac <- (round(exp(coeff.log.demo.vac[3,1]), 2))
odd.age.demo.vac <- (round(exp(coeff.log.demo.vac[4,1]), 2))
odd.edu2.demo.vac <- (round(exp(coeff.log.demo.vac[5,1]), 2))
odd.edu3.demo.vac <- (round(exp(coeff.log.demo.vac[6,1]), 2))
odd.sex.demo.vac <- (round(exp(coeff.log.demo.vac[7,1]), 2))

p.know.demo.vac <- coeff.log.demo.vac[2,4]	#p-value
p.pol.demo.vac <- coeff.log.demo.vac[3,4]
p.age.demo.vac <- coeff.log.demo.vac[4,4]
p.edu2.demo.vac <- coeff.log.demo.vac[5,4]
p.edu3.demo.vac <- coeff.log.demo.vac[6,4]
p.sex.demo.vac <- coeff.log.demo.vac[7,4]
...
ci.vac.demo.m.pol.a <-(round(exp(ci.vac.demo.m[3,1]),2))
ci.vac.demo.m.pol.b <-(round(exp(ci.vac.demo.m[3,2]),2))
ci.vac.demo.m.pol <- paste(ci.vac.demo.m.pol.a,ci.vac.demo.m.pol.b, sep="-")
ci.vac.demo.m.age.a <-(round(exp(ci.vac.demo.m[4,1]),2))
ci.vac.demo.m.age.b <-(round(exp(ci.vac.demo.m[4,2]),2))
ci.vac.demo.m.age <- paste(ci.vac.demo.m.age.a,ci.vac.demo.m.age.b, sep="-")
ci.vac.demo.m.edu2.a <-(round(exp(ci.vac.demo.m[5,1]),2))
ci.vac.demo.m.edu2.b <-(round(exp(ci.vac.demo.m[5,2]),2))
ci.vac.demo.m.edu2 <- paste(ci.vac.demo.m.edu2.a,ci.vac.demo.m.edu2.b, sep="-")
ci.vac.demo.m.edu3.a <-(round(exp(ci.vac.demo.m[6,1]),2))
ci.vac.demo.m.edu3.b <-(round(exp(ci.vac.demo.m[6,2]),2))
ci.vac.demo.m.edu3 <- paste(ci.vac.demo.m.edu3.a,ci.vac.demo.m.edu3.b, sep="-")
ci.vac.demo.m.sex.a <-(round(exp(ci.vac.demo.m[7,1]),2))
ci.vac.demo.m.sex.b <-(round(exp(ci.vac.demo.m[7,2]),2))
...
df.out.su.kn <- data.frame(Factor=c("Knowledge","Age","Ethnicity"),
...
df.multi.vac <- data.frame(Factor=c("Knowledge","Political View","Age", "No qualifications (reference catergory)","Non-degree level qualifications","Degree level qualifications","Sex"),
	Adjusted_OR=c(odd.know.demo.vac,odd.pol.demo.vac, odd.age.demo.vac ,"",odd.edu2.demo.vac,odd.edu3.demo.vac,odd.sex.demo.vac),
	CI = c(ci.vac.demo.m.know,ci.vac.demo.m.pol,ci.vac.demo.m.age,"",ci.vac.demo.m.edu2,ci.vac.demo.m.edu3,ci.vac.demo.m.sex),
	P = c(round(p.know.demo.vac,3) ,round(p.pol.demo.vac,3),round(p.age.demo.vac,3),"",round(p.edu2.demo.vac,3),round(p.edu3.demo.vac,3),round(p.sex.demo.vac,3)),
	Unadjusted_OR = c(round(exp(e.know.vac.1),2), round(exp(e.pol.vac.1),2),round(exp(e.age.vac.1),2), "", round(exp(e.edu2.vac.1)),round(exp(e.edu3.vac.1)),round(exp(e.sex.vac.1),2)),
	CI2 = c(ci.know.vac.u, ci.pol.vac.u, ci.age.vac.u, "",ci.edu2.vac.u, ci.edu3.vac.u, ci.sex.vac.u),
	P2 = c(round(p.know.vac.1,3),round(p.pol.vac.1,3),round(p.age.vac.1,3),"",round(p.edu2.vac.1,3),round(p.edu3.vac.1,3),round(p.sex.vac.1,3)))
...
## encoding a trust metric where each person scores between 0 and 1 (0 being no trust)
data1$Who2Trust <- rowSums( data1[,38:46] )/9.0
data1$Which2Trust <- rowSums( data1[,48:63] )/16.0
...
## Running a T test for which trust
Which2Trustneg <- data1$Which2Trust[tr==1]
Which2Trustpos <- data1$Which2Trust[tr==0]
var.test(Which2Trustneg,Which2Trustpos)	#p=0.006
Which2TrustTtr <- t.test(Which2Trustneg,Which2Trustpos, var.equal=FALSE)
Which2TrustTtr$statistic # -6.79
Which2TrustTtr$estimate # mean X = 0.192 mean Y = 0.252
Which2TrustTtr$p.value # 2.733e-11

## HYPE 
Who2Trustneg.hy <- data1$Who2Trust[hy==1]
Who2Trustpos.hy <- data1$Who2Trust[hy==0]
var.test(Who2Trustneg.hy,Who2Trustpos.hy)	#p=0.14, 
Who2TrustThy <- t.test(Who2Trustneg,Who2Trustpos, var.equal=TRUE)
Which2Trustneg.hy <- data1$Which2Trust[hy==1]
Which2Trustpos.hy <- data1$Which2Trust[hy==0]
var.test(Which2Trustneg.hy,Which2Trustpos.hy)	#p=0.07
Which2TrustThy <- t.test(Which2Trustneg.hy,Which2Trustpos.hy, var.equal=TRUE)


## GM
Who2Trustneg.gm <- data1$Who2Trust[gm==1]
Who2Trustpos.gm <- data1$Who2Trust[gm==0]
var.test(Who2Trustneg.gm,Who2Trustpos.gm)	#p=0.2, 
Who2TrustTgm<- t.test(Who2Trustneg,Who2Trustpos, var.equal=TRUE)
Which2Trustneg.gm <- data1$Which2Trust[gm==1]
Which2Trustpos.gm <- data1$Which2Trust[gm==0]
var.test(Which2Trustneg.gm,Which2Trustpos.gm)	#p=0.29
Which2TrustTgm <- t.test(Which2Trustneg.gm,Which2Trustpos.gm, var.equal=TRUE)


## Vac
Who2Trustneg.vac <- data1$Who2Trust[vac==1]
Who2Trustpos.vac <- data1$Who2Trust[vac==0]
var.test(Who2Trustneg.vac,Who2Trustpos.vac)	#p=0.0004, 
Who2TrustTvac <- t.test(Who2Trustneg,Who2Trustpos, var.equal=FALSE)
Which2Trustneg.vac <- data1$Which2Trust[vac==1]
Which2Trustpos.vac <- data1$Which2Trust[vac==0]
var.test(Which2Trustneg.vac,Which2Trustpos.vac)	#p=0.01
Which2TrustTvac <- t.test(Which2Trustneg.vac,Which2Trustpos.vac, var.equal=FALSE)
...
## Runnning holm test
t.test.holm <- p.adjust((t.test.P.values), "holm") <= 0.05
t.test.holm <- ifelse(t.test.holm == "FALSE" & t.test.P.values< .05, "!", "")

t.test.P.values.all <- paste(t.test.P.values,t.test.holm, sep="")
#printing out T value and significane levels and Holm test from P.value
t.test.all.df <- data.frame(Attitude=c("Trust","Hype","GM","Vac"), t_value =(t.values),P_Value=(t.test.P.values.all))
...
tabpct(gm,data1$WhoTrust04, graph= TRUE, main= "Celebrities and public figures", ylab = "Trust04", xlab = "GM")
tabpct(gm,data1$WhoTrust05, graph= TRUE, main= "Not-for-profit organisations", ylab = "Trust05", xlab = "GM")
tabpct(gm,data1$WhoTrust06, graph= TRUE, main= "NHS spokesperson", ylab = "Trust06", xlab = "GM")
...
tabpct(gm,data1$WhoTrust07, graph= TRUE, main= "Research Scientists/ Universities", ylab = "Research Scientists/ Universities", xlab = "GM")
tabpct(gm,data1$WhoTrust08, graph= TRUE, main= "Family/Friends", ylab = "Trust08", xlab = "GM")

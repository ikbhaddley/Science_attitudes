...
## Cronbach alpha on knowledge data
...
logistic.tr.demographic.2 <- glm(trust ~ know+su+rel2+rel3+edu2+edu3, data=df.tr.demographic.1, family="binomial")
...
odd.su.demo.tr <- round(exp(coeff.log.demo.tr[3,1]), 2)
odd.rel2.demo.tr <- round(exp(coeff.log.demo.tr[4,1]), 2)
odd.rel3.demo.tr <- round(exp(coeff.log.demo.tr[5,1]), 2)
odd.edu2.demo.tr <- round(exp(coeff.log.demo.tr[6,1]), 2)
odd.edu3.demo.tr <- round(exp(coeff.log.demo.tr[7,1]), 2)

p.know.demo.tr <- coeff.log.demo.tr[2,4]	#p-value
p.su.demo.tr <- coeff.log.demo.tr[3,4]
p.rel2.demo.tr <- coeff.log.demo.tr[4,4]
p.rel3.demo.tr <- coeff.log.demo.tr[5,4]
p.edu2.demo.tr <- coeff.log.demo.tr[6,4]
p.edu3.demo.tr <- coeff.log.demo.tr[7,4]
...
ci.tr.demo.m.su.a <-(round(exp(ci.tr.demo.m[3,1]),2))
ci.tr.demo.m.su.b <-(round(exp(ci.tr.demo.m[3,2]),2))
ci.tr.demo.m.su <- paste(ci.tr.demo.m.su.a,ci.tr.demo.m.su.b, sep="-")
ci.tr.demo.m.rel2.a <-(round(exp(ci.tr.demo.m[4,1]),2))
ci.tr.demo.m.rel2.b <-(round(exp(ci.tr.demo.m[4,2]),2))
ci.tr.demo.m.rel2 <- paste(ci.tr.demo.m.rel2.a,ci.tr.demo.m.rel2.b, sep="-")
ci.tr.demo.m.rel3.a <-(round(exp(ci.tr.demo.m[5,1]),2))
ci.tr.demo.m.rel3.b <-(round(exp(ci.tr.demo.m[5,2]),2))
ci.tr.demo.m.rel3 <- paste(ci.tr.demo.m.rel3.a,ci.tr.demo.m.rel3.b, sep="-")
ci.tr.demo.m.edu2.a <-(round(exp(ci.tr.demo.m[6,1]),2))
ci.tr.demo.m.edu2.b <-(round(exp(ci.tr.demo.m[6,2]),2))
ci.tr.demo.m.edu2 <- paste(ci.tr.demo.m.edu2.a,ci.tr.demo.m.edu2.b, sep="-")
ci.tr.demo.m.edu3.a <-(round(exp(ci.tr.demo.m[7,1]),2))
ci.tr.demo.m.edu3.b <-(round(exp(ci.tr.demo.m[7,2]),2))
ci.tr.demo.m.edu3 <- paste(ci.tr.demo.m.edu3.a,ci.tr.demo.m.edu3.b, sep="-")

## TRUST
## creating a data.frame
df.out.su.kn <- data.frame(Factor=c("Knowledge","Self-Understanding","Religious not practising","Religious Practising","Non-degree level qualifications","Degree level qualifications"),
	Adjusted_OR=c(odd.know.demo.tr,odd.su.demo.tr ,odd.rel2.demo.tr,odd.rel3.demo.tr,odd.edu2.demo.tr,odd.edu3.demo.tr),
	CI = c(ci.tr.demo.m.know, ci.tr.demo.m.su, ci.tr.demo.m.rel2,ci.tr.demo.m.rel3,ci.tr.demo.m.edu2,ci.tr.demo.m.edu3),
	P = c(round(p.know.demo.tr,3),round(p.su.demo.tr,3),round( p.rel2.demo.tr,3),round( p.rel3.demo.tr,3),round( p.edu2.demo.tr,3),round( p.edu3.demo.tr,3)),
	Unadjusted_OR = c(round(exp(e.know.tr.1),2), round(exp(e.su.tr.1),2), round(exp(e.rel2.tr.1)),round(exp(e.rel3.tr.1)),round(exp(e.edu2.tr.1)),round(exp(e.edu3.tr.1))),
	CI2 = c(ci.know.tr.u, ci.su.tr.u, ci.rel2.tr.u,ci.rel3.tr.u,ci.edu2.tr.u,ci.edu3.tr.u),
	P2 = c(round(p.know.tr.1,3),round(p.su.tr.1,3),round(p.rel2.tr.1,3),round(p.rel3.tr.1,3),round(p.edu2.tr.1,3),round(p.edu3.tr.1,3)))
...
#remove sex rel, pol, edu, know
logistic.gm.demographic.2 <- glm(gm ~ su+age,data=df.gm.demographic.1, family="binomial")
...
## calculating odds ratio from estimate values
odd.su.demo.gm <- round(exp(coeff.log.demo.gm[2,1]), 2)	#odds ratio
odd.age.demo.gm <- round(exp(coeff.log.demo.gm[3,1]), 2)
p.su.demo.gm <- coeff.log.demo.gm[2,4]	#p-value
p.age.demo.gm <- coeff.log.demo.gm[3,4]

#calculating confidence intervals
ci.gm.demo.m <- confint(logistic.gm.demographic.2, level = 0.95, trace=FALSE)
ci.gm.demo.m.su.a <-(round(exp(ci.gm.demo.m[2,1]),2))
ci.gm.demo.m.su.b <-(round(exp(ci.gm.demo.m[2,2]),2))
ci.gm.demo.m.su <- paste(ci.gm.demo.m.su.a,ci.gm.demo.m.su.b, sep="-")
...
df.multi.gm <- data.frame(Factor=c("Self-Understanding","Age"),
	Adjusted_OR=c(odd.su.demo.gm,odd.age.demo.gm),
	CI = c(ci.gm.demo.m.su,ci.gm.demo.m.age),
	P = c(round(p.su.demo.gm,3) ,round(p.age.demo.gm,3)),
	Unadjusted_OR = c(round(exp(e.su.gm.1),2), round(exp(e.age.gm.1),2)),
	CI2 = c(ci.su.gm.u, ci.age.gm.u),
	P2 = c(round(p.su.gm.1,3),round(p.age.gm.1,3)))
